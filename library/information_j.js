...
async function information()
  ...
  var data = {
    information: {
      info_tr: "Library adındaki bu dosya, vector'a ait bazı dataların, işlemlerin tutulduğu bölümdür.",
    ...
    author: "Ber4tbey",
    eva_info: "Vevtor Neural Assistant - Chatbot // Machine Learning - Deep Learning",
    version: findvalue,
    npm: true,
    cli: false,
    languages: {
